...
// Query untuk mengambil data penulis dari database
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahPenulisModal">
                                    Tambah Penulis
                                </button>
                            </div>
                            <table id="datatablesSimple" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        // Output data penulis ke dalam tabel
                                        while($row = $result->fetch_assoc()) {
                                            echo "<tr>";
                                            echo "<td>" . $row["nama"] . "</td>";
                                            echo "<td>
                                                    <a href='hapus_penulis.php?id=".$row['id']."' class='btn btn-danger btn-sm' onclick='return confirm(\"Yakin ingin menghapus penulis ini?\")'>Hapus</a>
                                                  </td>";
                                            echo "</tr>";
                                        }
                                    } else {
                                        echo "<tr><td colspan='2'>Tidak ada data penulis</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
